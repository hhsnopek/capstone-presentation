...
const coffee = "☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️ ☕️"
      ...
      <Spectacle theme={theme}>
        <Deck transition={["fade"]} transitionDuration={500} progress="pacman">
          <Slide bgColor="white">
            ...
            <Text fit caps bold textColor="orange">
              Admin Dashboard
            </Text>
          </Slide>
		  <Slide bgImage={images.orange}>
		  <Heading fit caps bold textColor="white" textSize="2em">
			  Who are you?
		  </Heading>
		  </Slide>
		  ...
		  <Slide bgColor="white" notes="<ul><li>We're in the demo already!</li><li>Show demo (login, logout)</li></ul>">
			...
			<Heading fit textColor="green" bold>But, how did we get here?</Heading>
		  </Slide>
		  <Slide bgColor="blueberry">
			  <Heading fill textColor="white">User Flow</Heading>
		  </Slide>
		  <Slide>
			  <Image src={images.flow}/>
		  </Slide>
		  <CodeSlide textSize="18px" lang="go"
		  transition={["fade"]}
		  code={code}
		  ranges={[
		  ...
		  <Slide>
			  <Heading fit textColor="eggplant">Neato, but why?</Heading>
		  </Slide>
		  ...
		  <Slide bgColor="body">
		  <Heading caps fit textColor="orange">Difficulties</Heading>
		  <List>
		      <ListItem textColor="white">Design</ListItem>
			  <ListItem textColor="white">Scalability</ListItem>
			  <ListItem textColor="white">Future Updates</ListItem>
			  <ListItem textColor="white">Debugging</ListItem>
			  <ListItem textColor="white">Carrot Requests & Requirements</ListItem>
		  </List>
		  </Slide>
		  <Slide bgColor="blueberry" notes="<ul><li>Solves scalability & future updates</li><li>useability becomes easy, just take a look</li></ul>">
			  <Heading textColor="white">Deployment</Heading>
			  <Heading textColor="body">With</Heading>
			  <Heading textColor="body">Docker</Heading>
			  <Heading>{"🐳"}</Heading>
		  </Slide>
		  <Slide bgColor="blueberry">
		      <CodePane textSize="18px" lang="bash">{"# Deploy the whole backend\n$ docker-compose up\n\n# Deploy a single container\n$ docker build url/to/docker_image"}
			  </CodePane>
		  </Slide>
		  <Slide bgColor="eggplant" notes="<ul><li>~300 cups of coffee</li><li>~160 hrs</li></ul>">
			  <Heading fill caps textColor="white">Effort</Heading>
		  </Slide>
		  <Slide>
			  <Heading caps fit textColor="green">What I've have learned</Heading>
			  <List textColor="body">
				  <ListItem>I drink to much coffee {"☕️"}</ListItem>
				  <ListItem>Docker setup & deployment</ListItem>
				  <ListItem>I feel like a nginx wizard {"✨ 🔮✨"}</ListItem>
				  <ListItem>How to build services for *nix machine</ListItem>
			  </List>
			</Slide>
			<Slide bgColor="orange" notes="<ul><li>Co-worker at Carrot broke my demo yesterday</li><li>Currently being developed until it's complete</li><li>Build out all the apps, as SPAs</li></ul>">
				<Heading fit textColor="white">The Future</Heading>
				<Heading fill textColor="white">of the</Heading>
				<Heading fit textColor="white">Dashboard</Heading>
		    </Slide>
			<Slide bgColor="green">
				<Heading textColor="white">Thank you,</Heading>
				<Heading fit textColor="white">Questions?</Heading>
			</Slide>
			<Slide>
